...
namespace FunPay_Monitoring_Bot
{
    internal class Program
    {
        ...
        static Monitoring mon_Lame1339_2 = new Monitoring(2);
        ...
        static Monitoring mon_Savelentino_2 = new Monitoring(2);
        static Monitoring mon_Savelentino_3 = new Monitoring(3);
        ...
        static Monitoring mon_Martin0605_1 = new Monitoring(1);
        public static int Martin0605_day = 0;

        static Monitoring mon_dream1265_1 = new Monitoring(1);
        public static int dream1265_day = 0;

        static Monitoring mon_yurexzzz_1 = new Monitoring(1);
        public static int yurexzzz_day = 0;

        static Monitoring mon_jr7_1 = new Monitoring(1);
        public static int jr7_day = 0;

        static Monitoring mon_opiumthuge_1 = new Monitoring(1);
        public static int opiumthuge_day = 0;

        static Monitoring mon_lookwerm_1 = new Monitoring(1);
        public static int lookwerm_day = 0;

        static Monitoring mon_Kurtiklegend_1 = new Monitoring(1);
        public static int Kurtiklegend_day = 0;
        ...
        */
        ...
        {
            Update_bases.Update_day("yurexzzz", yurexzzz_day, day_now); yurexzzz_day = 0;
            Update_bases.Update_day("jr7", jr7_day, day_now); jr7_day = 0;
            Update_bases.Update_day("opiumthuge", opiumthuge_day, day_now); opiumthuge_day = 0;
            Update_bases.Update_day("lookwerm", lookwerm_day, day_now); lookwerm_day = 0;
            Update_bases.Update_day("Kurtiklegend", Kurtiklegend_day, day_now); Kurtiklegend_day = 0;
            Update_bases.Update_day("Martin0605", Martin0605_day, day_now); Martin0605_day = 0;
            ...
            Update_bases.Update_day("dream1265", dream1265_day, day_now); dream1265_day = 0;
        }
        
        public static void yurexzzz()
        {
            yurexzzz_day += mon_yurexzzz_1.Monitor("yurexzzz", "https://funpay.com/lots/offer?id=24149788");
        }
        public static void jr7()
        {
            jr7_day += mon_jr7_1.Monitor("jr7", "https://funpay.com/lots/offer?id=24191738");
        }
        public static void opiumthuge()
        {
            opiumthuge_day += mon_opiumthuge_1.Monitor("opiumthuge", "https://funpay.com/lots/offer?id=24169071");
        }
        public static void lookwerm()
        {
            lookwerm_day += mon_lookwerm_1.Monitor("lookwerm", "https://funpay.com/lots/offer?id=24129938");
        }
        public static void Kurtiklegend()
        {
            Kurtiklegend_day += mon_Kurtiklegend_1.Monitor("Kurtiklegend", "https://funpay.com/lots/offer?id=23998573");
        }
        public static void dream1265()
        {
            dream1265_day += mon_dream1265_1.Monitor("dream1265", "https://funpay.com/lots/offer?id=24003921");
        }
        public static void Martin0605()
        {
            Martin0605_day += mon_Martin0605_1.Monitor("Martin0605", "https://funpay.com/lots/offer?id=24162836");
        }
        ...
        {
            Savelentino_day += mon_Savelentino_1.Monitor("Savelentino", "https://funpay.com/lots/offer?id=24200582");
            Savelentino_day += mon_Savelentino_2.Monitor("Savelentino", "https://funpay.com/lots/offer?id=24200469");
            Savelentino_day += mon_Savelentino_3.Monitor("Savelentino", "https://funpay.com/lots/offer?id=24200380");
        }
        ...
        public static void Lame1339()
        {
            ...
            Lame1339_day += mon_Lame1339_2.Monitor("Lame1339", "https://funpay.com/lots/offer?id=24191789");
        }
