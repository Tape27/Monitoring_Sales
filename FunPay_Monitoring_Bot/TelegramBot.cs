    ...
    internal class TelegramBot
    {
                ...
                if (message.Text != null)
                {
                    ...
                    if (message.Text == "/start")
                    {
                        ...
                        await bot.SendTextMessageAsync(message.Chat.Id, "*Бот по мониторингу продаж на Funpay*\n\n" +
                            ...
                            $"*Мониторинг ведется с 12/12/2023  20:07*",
        ...
        public string TopDay()
        {
            Dictionary<string, int> users = new Dictionary<string, int>
            {
                ...
                { "Martin0605", Program.Martin0605_day },
                { "dream1265", Program.dream1265_day },
                { "Kurtiklegend", Program.Kurtiklegend_day },
                { "lookwerm", Program.lookwerm_day },
                { "opiumthuge", Program.opiumthuge_day },
                { "jr7", Program.jr7_day },
                { "yurexzzz", Program.yurexzzz_day }
        ...
        {
            string[] array_users = { "yurexzzz","jr7","opiumthuge","lookwerm", "Kurtiklegend","dream1265","Martin0605", "canek52", "Tape27", "destorsh", "Slashee", "Mashs8", "gilzzz", "chimadima1",
